...
public class ExcelReaderUtil {
    private static int sheetTree = 234;
    /**
    ...
    public static List<List<String>> readExcel(String path) {
        ...
        try {
            ...
            if (fileType.equals("xls")) {
                ...
                //读取第一个工作页sheet
                Sheet sheet = wb.getSheetAt(sheetTree);
                System.out.println();
    ...
    public static void main(String[] args) throws IOException {
        String path = "C:\\Users\\朱昊辉\\Documents\\WeChat Files\\FeiGeZuiSuai\\FileStorage\\File\\2019-08\\所有值域代码表及字典-20190602.xls";
